...
class SwinUNETR(nn.Module):
    ...
    def forward(self, x_in):
        ...
        # if layer == -2:
        #     convdec0 = nn.Conv3d(48, 7, kernel_size=1, stride=1, padding=0).cuda()
        ...
        # elif layer == -3:
        #     convdec1 = nn.Conv3d(96, 7, kernel_size=1, stride=1, padding=0).cuda()
        ...
        # elif layer == -4:
        #     convdec2 = nn.Conv3d(192, 7, kernel_size=1, stride=1, padding=0).cuda()
